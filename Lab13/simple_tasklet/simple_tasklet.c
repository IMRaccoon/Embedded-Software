...
static irqreturn_t simple_tasket_isr(int irq, void* data) {
...
static int __init simple_tasklet_init(void) {
    ...
    ret = request_irq(irq_num, simple_tasket_isr, IRQF_TRIGGER_FALLING, "switch_irq", NULL);
